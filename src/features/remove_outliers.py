...
df[outliers_col[:3] + ["label"]].boxplot(by="label", figsize=(20, 10), layout=(1, 3))
df[outliers_col[3:] + ["label"]].boxplot(by="label", figsize=(20, 10), layout=(1, 3))
...
df[outliers_col[:3] + ["label"]].plot.hist(by="label", figsize=(20, 20), layout=(3, 3))
df[outliers_col[3:] + ["label"]].plot.hist(by="label", figsize=(20, 20), layout=(3, 3))
...
# Loop over all columns
dataset, outliers, X_scores = mark_outliers_lof(df, outliers_col)
for col in outliers_col:
    plot_binary_outliers(
...
dataset, outliers, X_scores = mark_outliers_lof(df[df["label"] == label], outliers_col)
for col in outliers_col:
    plot_binary_outliers(
        dataset=dataset, col=col, outlier_col="outlier_lof", reset_index=True
    )
